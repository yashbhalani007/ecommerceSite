    ...
    return (
        <div id='app'>
            <div>
                ...
                <div className="page-directory u-s-p-t-80">
                    <div className="container">
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main" href="shop-v2-sub-category.html">Tops</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Outwear</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Accessories</a>
                                        </li>
                                        <li>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Bottoms</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Underwear</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Sunglasses</a>
                                        </li>
                                        <li>
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Tops</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Intimates</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Wedding &amp; Events</a>
                                        </li>
                                        <li>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Outwear &amp; Jackets</a>
                                        </li>
                                        <li>
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">RC Toys &amp; Hobbies</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Learning &amp; Education</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="shop-v3-sub-sub-category.html" className="dir-list-main">Dolls &amp; Stuffed Toys</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="shop-v3-sub-sub-category.html" className="dir-list-main">Model &amp; Building Toys</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v3-sub-sub-category.html" className="dir-list-main">Musical Instruments</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a className="dir-list-main">Solar Energy</a>
                                        </li>
                                        <li>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">RC Robot</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Gadget Toys</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Classic &amp; Retro Toys</a>
                                        </li>
                                        <li>
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="dir-sub-wrapper">
                                <div className="dir-sub-heading">
                                    <a>Smart Phones</a>
                                </div>
                                <div className="row">
                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            ...
                            <div className="dir-remain-categories">
                                <div className="dir-remain-heading">Other Categories</div>
                                <ul className="dir-list-wrap">
                                    <li>
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Laptops</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">PC &amp; Accessories</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">TV's</a>
                                        </li>
                                        <li>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Camera &amp; Camcorders</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Audio &amp; Amplifiers</a>
                                        </li>
                                        <li>
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v1-root-category.html" className="dir-list-main">Fiction &amp; Literature</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Kids &amp; Teens</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Nonfiction</a>
                                        </li>
                                        <li>
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Make up</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Skin Care</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Personal Care</a>
                                        </li>
                                        <li>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Hair Care</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Health Care</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Fragrances</a>
                                        </li>
                                        <li>
                        ...
                        <div className="directory-wrapper">
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v2-sub-category.html" className="dir-list-main">Furniture</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v3-sub-sub-category.html" className="dir-list-main">Bedding</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Home Decor</a>
                                        </li>
                                        <li>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Kitchen &amp; Dinning</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a className="dir-list-main">Household Supplies</a>
                                        </li>
                                        <li>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <ul className="dir-list-wrap">
                                        <li>
                                            <a href="shop-v3-sub-sub-category.html" className="dir-list-main">Bath</a>
                                        </li>
                                        <li>

    ...
    return (
        <div id='app'>
            <div>
                ...
                {/* FAQ-Page */}
                <div className="page-faq u-s-p-t-80">
                    <div className="container">
                        <div className="faq u-s-m-b-50">
                        ...
                        <div className="u-s-m-b-50">
                            <div className="f-a-q u-s-m-b-30">
                                <a data-toggle="collapse" href="#faq-1">How can I get discount coupon ?</a>
                                <div className="collapse show" id="faq-1">
                                    <p>
                            ...
                            <div className="f-a-q u-s-m-b-30">
                                ...
                                <div className="collapse" id="faq-6">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda blanditiis error incidunt laborum modi nisi odio. Aut dolore earum fugit itaque laborum, necessitatibus quos ullam. Dolores ex porro praesentium sequi.
                                    </p>
                                </div>
                            ...
                            <div className="f-a-q u-s-m-b-30">
                                ...
                                <div className="collapse" id="faq-7">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda blanditiis error incidunt laborum modi nisi odio. Aut dolore earum fugit itaque laborum, necessitatibus quos ullam. Dolores ex porro praesentium sequi.
                                    </p>
                                </div>
                            ...
                            <div className="f-a-q u-s-m-b-30">
                                ...
                                <div className="collapse" id="faq-8">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda blanditiis error incidunt laborum modi nisi odio. Aut dolore earum fugit itaque laborum, necessitatibus quos ullam. Dolores ex porro praesentium sequi.
                                    </p>
                                </div>

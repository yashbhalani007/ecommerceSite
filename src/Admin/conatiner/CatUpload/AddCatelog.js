          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                ...
                <input id="ecommerce-product-tags" className="form-control" name="ecommerce-product-tags" defaultValue="Normal,Standard,Premium" aria-label="Product Tags" />
              </div>
            </div>
          </div>
          {/* /Organize Card */}
